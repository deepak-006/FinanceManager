...
public class OctActivity extends AppCompatActivity implements PopupMenu.OnMenuItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        return1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(OctActivity.this, HomeActivity.class);
    ...
    private void loadData() {
        ...
        Gson gson = new Gson();
        String json = sharedPreferences.getString("dates10", null);
