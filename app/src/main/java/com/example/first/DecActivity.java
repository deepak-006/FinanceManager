...
public class DecActivity extends AppCompatActivity implements PopupMenu.OnMenuItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        return1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(DecActivity.this, HomeActivity.class);
    ...
    private void loadData() {
        ...
        Gson gson = new Gson();
        String json = sharedPreferences.getString("dates12", null);
