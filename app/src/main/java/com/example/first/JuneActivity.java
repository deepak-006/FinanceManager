...
public class JuneActivity extends AppCompatActivity implements PopupMenu.OnMenuItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        return1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(JuneActivity.this, HomeActivity.class);
    ...
    private void loadData() {
        ...
        Gson gson = new Gson();
        String json = sharedPreferences.getString("dates6", null);
